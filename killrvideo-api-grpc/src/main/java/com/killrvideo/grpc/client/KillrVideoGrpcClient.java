package com.killrvideo.grpc.client;
...
import killrvideo.uploads.UploadsServiceGrpc.UploadsServiceBlockingStub;
...
public class KillrVideoGrpcClient {
    ...
    public UploadsServiceBlockingStub          uploadServiceGrpcClient;
    ...
    public void initServiceClients() {
        ...
        uploadServiceGrpcClient          = UploadsServiceGrpc.newBlockingStub(grpcEndPoint);
    ...
    /**
     * Getter accessor for attribute 'uploadServiceGrpcClient'.
     *
     * @return
     *       current value of 'uploadServiceGrpcClient'
     */
    public UploadsServiceBlockingStub getUploadService() {
        return uploadServiceGrpcClient;
    }
