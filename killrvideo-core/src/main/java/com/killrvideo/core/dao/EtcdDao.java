...
public class EtcdDao {
    ...
    /**
     * Build Service key in GRPC.
     *
     * @param appUid
     * @param serviceDescName
     * @return
     */
    public String buildServiceKey(String appUid, String serviceDescName) {
        String shortName  = shortenServiceName(serviceDescName);
        return format("/killrvideo/services/%s/%s", shortName, appUid);
    }
    
    /**
     * Remove special caracters.
     */
    public String shortenServiceName(String fullServiceName) {
